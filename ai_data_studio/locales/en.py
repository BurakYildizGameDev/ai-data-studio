...
MESSAGES = {
    ...
    "license.status.ls_rejected": "Lemon Squeezy rejected this license key ({reason})",
    "license.status.ls_no_reason": "no reason given",
    "license.status.ls_offline": "Could not reach Lemon Squeezy to check this license key. Check your internet connection and try again.",
    "license.status.ls_unreadable": "Lemon Squeezy returned an unreadable response; try again in a moment",
    "license.status.ls_wrong_store": "This license key belongs to a different product or store",
    "license.status.ls_test_mode": "This is a Lemon Squeezy test-mode key and does not unlock a paid edition",
    "license.status.ls_test_mode_active": "Active (TEST-mode key, not a paid licence)",
    "license.status.ls_limit_reached": "This license key has used all of its activations ({used}/{limit}). Deactivate it on another machine first.",
    "license.status.ls_revalidate_failed": "This license has not been re-checked with the store for {days} days. Connect to the internet and restart the app.",
    "license.status.ls_not_activated": "This license key has not been activated yet; paste it into the box and press Activate",
    ...
    "settings.license.key_placeholder": "Paste your ADS-... token or your Lemon Squeezy license key",
    ...
    "license.dialog.contacting_store": "Contacting the store...",
