...
MESSAGES = {
    ...
    "license.status.ls_rejected": "Lemon Squeezy bu lisans anahtarını reddetti ({reason})",
    "license.status.ls_no_reason": "gerekçe belirtilmedi",
    "license.status.ls_offline": "Lisans anahtarı doğrulanamadı: Lemon Squeezy'ye ulaşılamıyor. İnternet bağlantınızı kontrol edip yeniden deneyin.",
    "license.status.ls_unreadable": "Lemon Squeezy okunamayan bir yanıt döndürdü; birazdan yeniden deneyin",
    "license.status.ls_wrong_store": "Bu lisans anahtarı başka bir ürüne ya da mağazaya ait",
    "license.status.ls_test_mode": "Bu, Lemon Squeezy test modunda üretilmiş bir anahtar; ücretli sürümü açmaz",
    "license.status.ls_test_mode_active": "Etkin (TEST modu anahtarı, ücretli lisans değil)",
    "license.status.ls_limit_reached": "Bu lisans anahtarının etkinleştirme hakkı doldu ({used}/{limit}). Önce başka bir makinede devre dışı bırakın.",
    "license.status.ls_revalidate_failed": "Bu lisans {days} gündür mağazada yeniden doğrulanamadı. İnternete bağlanıp uygulamayı yeniden başlatın.",
    "license.status.ls_not_activated": "Bu lisans anahtarı henüz etkinleştirilmedi; kutuya yapıştırıp Etkinleştir'e basın",
    ...
    "settings.license.key_placeholder": "ADS-... token'ınızı ya da Lemon Squeezy lisans anahtarınızı yapıştırın",
    ...
    "license.dialog.contacting_store": "Mağazaya bağlanılıyor...",
